...
const toggletLikeComment = require("../use-cases/toggle-like-comment");
...
router.post(
    ...
    authGuard,
    handleAsyncError(async (req, res) => {
        //Hacer toggle del like en el comment
        await toggletLikeComment(req.params.id, req.currentUser.id);
        sendResponse(res);
    })
);
router.post(
